...
if __name__ == '__main__':
    ...
    signal_time = rng.normal(0.0, 1.0, ND)
    ...
    print(
        'got time->freq in             %10.7fs %12.7f X fft time' % ((t7 - t6) / n_run, (t7 - t6) / n_run / time_scale),
    )
    ...
    print(
        'got freq->time in             %10.7fs %12.7f X fft time' % ((t3 - t2) / n_run, (t3 - t2) / n_run / time_scale),
    )
    ...
    print(
        'got wavelet->freq in          %10.7fs %12.7f X fft time' % ((t1 - t0) / n_run, (t1 - t0) / n_run / time_scale),
    )
    ...
    print(
        'got wavelet->time in          %10.7fs %12.7f X fft time' % ((t5 - t4) / n_run, (t5 - t4) / n_run / time_scale),
    )
    ...
    print(
        'got wavelet->freq->time in    %10.7fs %12.7f X fft time' % ((t9 - t8) / n_run, (t9 - t8) / n_run / time_scale),
    )
    ...
    print(
        'got freq->wavelet in          %10.7fs %12.7f X fft time'
        % ((t11 - t10) / n_run, (t11 - t10) / n_run / time_scale),
    )
    ...
    print(
        'got time->wavelet in          %10.7fs %12.7f X fft time'
        % ((t13 - t12) / n_run, (t13 - t12) / n_run / time_scale),
    )
    ...
    print(
        'got time->freq->wavelet in    %10.7fs %12.7f X fft time'
        % ((t15 - t14) / n_run, (t15 - t14) / n_run / time_scale),
    )
